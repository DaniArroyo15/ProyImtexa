...
namespace AppWeb.Areas.Ventas.Controllers
{
    public class ClienteController : Controller
    {
        ...
        {
            string iRpta = "";
            iRpta = odaSQL.EjecutarComando("paCliente_Listar");
            //
            return iRpta;
        }
        public string ListId(string pId)
        {
            ...
            iRpta = odaSQL.EjecutarComando("paCliente_ListarPorId", "@pvcData", pId);
            return iRpta;
        }
        ...
        public string Add()
        {
            ...
            iRpta = odaSQL.EjecutarComando("paCliente_Agregar", "@pvcData", iData);
            return iRpta;
        }
        public string Modify()
        {
            ...
            iRpta = odaSQL.EjecutarComando("paCliente_Modificar", "@pvcData", iData);
            return iRpta;
        }
        public string Delete(string pId)
        {
            ...
            iRpta = odaSQL.EjecutarComando("paCliente_Eliminar", "@pvcData", iData);
            return iRpta;
        }
    }
}