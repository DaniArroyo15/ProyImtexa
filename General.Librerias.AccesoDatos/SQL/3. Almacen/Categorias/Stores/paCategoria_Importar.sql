...
IF EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'paCategoria_Importar')
BEGIN
	--GRANT EXECUTE ON dbo.paCategoria_Importar TO dbUser;
	PRINT 'SP Create : paCategoria_Importar';
	PRINT '***'
END
GO